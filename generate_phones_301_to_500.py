#!/usr/bin/env python3
"""
Tạo phones_301.txt .. phones_500.txt từ phones_aca.txt, phones_all.txt, phones_200k.txt.
Mỗi file ~10.000 số. Random đổi 1 hoặc 2 chữ số (trừ đầu 0) để trông tự nhiên.
Chạy: python generate_phones_301_to_500.py
"""
...
START_NUM = 301
NUM_FILES = 200   # phones_301 .. phones_500
TARGET_PER_FILE = 10_000
TOTAL_NEEDED = NUM_FILES * TARGET_PER_FILE  # 2_000_000
...
def main():
    ...
    print(f"Mỗi file ~{TARGET_PER_FILE} số.")
